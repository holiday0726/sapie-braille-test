...
class SplitPDFFilesNode(BaseNode):
    ...
    def __init__(self, batch_size, test_page=None, **kwargs):
    ...
    def execute(self, state: ParserState) -> ParserState:
        ...
        for start_page in range(0, num_pages, self.batch_size):
            ...
            output_file = f"{dir_path}/{input_file_basename}_{start_page:04d}_{end_page:04d}.pdf"
